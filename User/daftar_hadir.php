...
if (isset($_POST["submit"])) {
 ...
 ";
    ...
    $hari = date('Y-m-d');
    $harian = mysqli_query($conn, "SELECT * FROM data_kehadiran WHERE tanggal = $hari");
                ...
                <form action="" method="post">
                    <div class="row g-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="nisn" id="nisn" class="form-control form-control-sm" required disabled>
                                
                                <?php
                                $nama = $_SESSION['username'];
                                $query = mysqli_query($conn, "SELECT nama,nisn FROM siswa WHERE nisn = $nama") or die(mysqli_error($conn));

                                while ($data = mysqli_fetch_array($query)) {
                                    echo "<option value=$data[nisn]>$data[nama]</option>";
                                }
                                ?>
