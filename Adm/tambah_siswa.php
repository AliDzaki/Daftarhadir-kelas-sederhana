                ...
                <form action="" method="post">
                    <div class="row g-3">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="nisn" id="nisn" class="form-control form-control-sm" required>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <select name="kelamin" id="kel" class="form-select form-select-sm" required>
                        ...
                        <div class="mb-2">
                            ...
                            <input name="tgl_lahir" id="tgl" type="date" class="form-control form-control-sm" required>

                        </div>

                    </div>
                    <button type="submit" name="submit" class="btn btn-primary btn mt-3">Tambah
                        Siswa</button>
                </form>
            </div>
