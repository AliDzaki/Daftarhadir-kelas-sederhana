    ...
    <div class="contain ">
        ...
        <div id="main-content">
            ...
            <div class="">
                ...
                <button type="button  " class="btn btn-secondary mb-2" >Tambah data</button>
                </a>
            </div>
            <div>
                <table class="table table-striped ">
                    ...
                    <?php foreach ($siswa as $swa) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="hapus_siswa.php?nisn=<?= $swa["nisn"] ?>" class="btn btn-success btn-sm" onclick="return confirm('yakin?');">HAPUS</a>
                                <a href="ubah_siswa.php?nisn=<?= $swa["nisn"] ?>" class="btn btn-success btn-sm" onclick="return confirm('yakin?');">UBAH</a>
                            </td>
